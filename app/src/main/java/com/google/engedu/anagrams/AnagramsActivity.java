...
public class AnagramsActivity extends AppCompatActivity {
    ...
    private ArrayList<String> anagramWithExtra;
    ...
    private void processWord(EditText editText) {
        ...
        String color = "#cc0029";
        if (dictionary.isGoodWord(word, currentWord) &&( anagramWithExtra.contains(word)||(anagrams.contains(word)))) {
    ...
    public boolean defaultAction(View view) {
        ...
        if (currentWord == null) {
            ...
            anagramWithExtra=dictionary.getAnagramsWithOneMoreLetter(currentWord);
